...
public class ExcelUtils {
	...
	public static String download(String fileName, String[] columnNames,
			String[] keys, List<Map<String,Object>> list, HttpServletResponse response) {
		BufferedInputStream bis = null;
		BufferedOutputStream bos = null;
		try {
			ByteArrayOutputStream os = new ByteArrayOutputStream();
			createWorkBook(list, columnNames, keys).write(os);
